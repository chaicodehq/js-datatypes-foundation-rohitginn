...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  // Your code here
  const regular = typeof regularMenu === "object" && regularMenu !== null &&
    !Array.isArray(regularMenu) ? regularMenu : {};
  const special = typeof specialsMenu === "object" && specialsMenu !== null &&
    !Array.isArray(specialsMenu) ? specialsMenu : {};
